...
@Component({
  selector: 'app-review-field-empty',
  templateUrl: './review-field.component.html'
})
export class ReviewFieldEmptyComponent extends ReviewFieldComponent {
  ...
  public test(): boolean {
    return this.viewHelper.isErrorCodeEmpty(this.property);
  }
}
